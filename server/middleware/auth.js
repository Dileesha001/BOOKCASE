...
const protect = async (req, res, next) => {
  ...
  if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
    try {
      ...
      const decoded = jwt.verify(token, process.env.JWT_SECRET || 'bookcase_super_secret_jwt_key_2026');
...
// Middleware to grant access only to specific user roles (e.g. admin, staff)
